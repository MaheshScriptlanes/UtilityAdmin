...
@Component({
  ...
  styleUrls: ['./edit-case-study.component.scss']
})
export class EditCaseStudyComponent implements OnInit {
  baseUrl=environment.baseurl;
  constructor(private fb:FormBuilder,private caseStudeService:OurClientService,private route:Router,private activatedRoute:ActivatedRoute,private snackbar:SnackbarService) { 
...
getData(){
  ...
  this.caseStudeService.postData("getCaseStudiesDetails",data).subscribe((res:any)=>{
...
this.caseStudeService.postData("editCaseStudies",this.editCaseStudyform.value).subscribe((res:any)=>{
...
getImages(){
  this.modalOpen=true;
  this.caseStudeService.getData("getBackgroundImages").subscribe((res:any)=>{
...
uploadImage(){
  this.selectedFile.forEach(obj => {
    ...
    this.caseStudeService.postData("uploadBackgroundImages",formData).subscribe((res:any)=>{
